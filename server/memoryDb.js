/**
 * memoryDb.js — In-memory database fallback implementing DatabaseStrategy
 *
 * Design Pattern: Strategy (concrete strategy)
 * Provides the same query interface as PostgresStrategy but stores data in Maps.
...
// ── MemoryStrategy (extends DatabaseStrategy) ─────────────────────────────
...
// Export a singleton instance (Strategy pattern — one concrete strategy)
